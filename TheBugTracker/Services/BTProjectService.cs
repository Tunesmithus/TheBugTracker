...
namespace TheBugTracker.Services
{
    public class BTProjectService : IBTProjectService
    {
        ...
        private readonly UserManager<BTUser> _user;
        private readonly IBTRolesService _rolesService;

        public BTProjectService(ApplicationDbContext context, UserManager<BTUser> user, IBTRolesService rolesService)
        {
            _context = context;
            _user = user;
        ...
        public async Task RemoveProjectManagerAsync(int projectId)
        {
            ...
            try
            {
                ...
                {
                    if (await _rolesService.IsUserInRoleAsync(bTUser, Roles.ProjectManager.ToString()))
                    {
                        await RemoveUserFromProjectAsync(bTUser.Id, projectId);
                    }
                }
            }
            catch
