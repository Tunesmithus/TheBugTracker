...
namespace TheBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Created,Description,UserId,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Created,Description,UserId,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
